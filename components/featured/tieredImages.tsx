  ...
  return (
    <Container>
      <div className="bg-white">
        <div className="mx-auto w-full py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-y-16 gap-x-8 lg:grid-cols-2">
            <div>
              <div className="overflow-hidden rounded-lg bg-gray-100">
                <img
                  src="https://lasvegas.wpresidence.net/wp-content/uploads/2022/03/team2.jpeg"
