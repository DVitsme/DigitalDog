  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Digital Dog Photography is a full-service real estate media compnay
        offering agents a range of services including listing photos and videos,
        3D tours, and branding content.
      </p>
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="/register">Book With Us</Button>
        <Button
